...
{ 
	...
	{	
		...
		if (!(phase_fast % 3))
		{
  			Souliss_DigIn(4, Souliss_T1n_ToogleCmd, memory_map, LIGHT1_NODE2);	
		        Souliss_Logic_T11(memory_map, LIGHT1_NODE2, &data_changed);
			Souliss_DigOut(6, Souliss_T1n_Coil, memory_map, LIGHT1_NODE2);	
