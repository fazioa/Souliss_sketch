...
{	
	...
	//Souliss_SetLocalAddress(memory_map, network_chibi_address);	
	...
	{	
          ...
          if (!(phase_fast % 3))
	  {
		...
		// Use OPEN and CLOSE Commands
	        Souliss_DigIn(iPin_DigIn, Souliss_T2n_OpenCmd, memory_map, CURTAIN_slot1);
		Souliss_DigIn(++iPin_DigIn, Souliss_T2n_CloseCmd, memory_map, CURTAIN_slot1);	

		Souliss_DigIn(++iPin_DigIn, Souliss_T2n_OpenCmd, memory_map, CURTAIN_slot2);	
		Souliss_DigIn(++iPin_DigIn, Souliss_T2n_CloseCmd, memory_map, CURTAIN_slot2);	
