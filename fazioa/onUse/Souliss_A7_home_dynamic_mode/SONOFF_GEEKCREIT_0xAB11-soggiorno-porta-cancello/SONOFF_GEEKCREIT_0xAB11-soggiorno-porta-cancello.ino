...
#define PIN_OUTPUT_REMOTE_CONTROLLER 12
#define PIN_OUTPUT_APRIPORTA 14
#define PIN_LED 13
...
void setup()
{
  ...
  //*************************************************************************
  //*************************************************************************
  Set_PulseOutput(SLOT_REMOTE_CONTROLLER_RELE1);
  Set_PulseOutput(SLOT_APRIPORTA_RELE2);
...
void loop()
{
  EXECUTEFAST() {
    UPDATEFAST();
     ...
     FAST_710ms() {
      DigIn(PIN_LEFT_BUTTON_0, Souliss_T1n_ToggleCmd, SLOT_REMOTE_CONTROLLER_RELE1);
      Logic_PulseOutput(SLOT_REMOTE_CONTROLLER_RELE1);
      DigOut(PIN_OUTPUT_REMOTE_CONTROLLER, Souliss_T1n_Coil, SLOT_REMOTE_CONTROLLER_RELE1);

      DigIn(PIN_MIDDLE_BUTTON_9, Souliss_T1n_ToggleCmd, SLOT_APRIPORTA_RELE2);
      Logic_PulseOutput(SLOT_APRIPORTA_RELE2);
      DigOut(PIN_OUTPUT_APRIPORTA, Souliss_T1n_Coil, SLOT_APRIPORTA_RELE2);
    }
