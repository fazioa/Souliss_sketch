...
// -- Project -------------------------------------
#define PROJECT                "Sonoff Pow R2"          // PROJECT is used as the default topic delimiter
#define MODULE                 SONOFF_POW_R2      // [Module] Select default model from sonoff_template.h (Should not be changed)
...
#define FRIENDLY_NAME          "Sonoff Pow R2"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
// -- Location ------------------------------------
#define LATITUDE               43.556244         // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              10.331222          // [Longitude] Your location to be used with sunrise and sunset
