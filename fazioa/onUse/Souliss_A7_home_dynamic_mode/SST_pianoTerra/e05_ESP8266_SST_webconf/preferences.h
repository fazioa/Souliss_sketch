...
#define C4_AREA_TEXT ""
#define C4_AREA_TEXT_COLOR_LAYOUT2() ucg.setColor(255, 255, 255); //White

#define C5_COLOR()  ucg.setColor(255, 255, 255);     // White
#define C5_AREA_UNITY ""
#define C5_AREA_TEXT ""
#define C5_AREA_TEXT_COLOR_LAYOUT2() ucg.setColor(255, 255, 255); //White

#define C6_COLOR()  ucg.setColor(255, 255, 255);    // White
#define C6_AREA_UNITY ""
#define C6_AREA_TEXT ""
#define C6_AREA_TEXT_COLOR_LAYOUT2() ucg.setColor(255, 255, 255); //White
